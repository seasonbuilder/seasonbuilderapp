...
additional_instructions = f"The user's name is {st.session_state.fname}. They are a {st.session_state.role} in the sport of {st.session_state.team} at the {st.session_state.school} and their native language is {st.session_state.language}. When you respond, determine the language you respond in.  If your response is not given to them in the native language they told, give a response in their native language too."
