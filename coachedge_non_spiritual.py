    ...
    with col2:
        ...
        st.markdown(
            ...
            <a href="https://play.google.com/store/apps/details?id=com.coachedge.android" target="_blank">
                <img src="https://en.m.wikipedia.org/wiki/File:Google_Play_Store_badge_EN.svg#/media/File%3AGoogle_Play_Store_badge_EN.svg" 
                     alt="Get it on Google Play" style="height: 100px;">
