...
typed_input = st.chat_input("How can I help you elevate your life?", on_submit=disable, args=(True,), disabled=st.session_state.get("disabled", False)) 
...
if st.session_state.prompt:
    with st.spinner("Thinking ......give me a minute"):
         time.sleep(5)  # Simulate immediate delay
