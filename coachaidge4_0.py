...
if st.session_state.display_result:
    ...
    if st.button('How important are relationships to my overall well being and how do I create meaningful ones?', on_click=btn_b_callback, args=(True,), disabled=st.session_state.get("disabled", False)):
    ...
    if st.button('How can I reduce stress and anxiety caused by sports and school?', on_click=disable, args=(True,), disabled=st.session_state.get("disabled", False)):
