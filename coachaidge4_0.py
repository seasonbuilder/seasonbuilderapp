...
if st.button('How do I combat the negative voice in my head?', on_click=disable_button):
    st.session_state.prompt = 'How do I combat the negative voice in my head?'

if st.button('How can I reduce stress and anxiety caused by sports and school?', on_click=disable_button):
    st.session_state.prompt = 'How can I reduce stress and anxiety caused by sports and school?'

if st.button('How do I stay positive while recovering from an injury?', on_click=disable_button):
    st.session_state.prompt = 'How do I stay positive while recovering from an injury?'

if st.button('Give me 15 possible insecurities I might have about myself that are keeping me from playing at the level I know I am capable of', on_click=disable_button):
...
if st.button('What are limiting beliefs and how are they impacting my life right now?', on_click=disable_button):
